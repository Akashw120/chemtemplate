...
const staticSourceAnsListGenerate = () => {
    ...
    mainQuestions.forEach((question) => {
        ...
        let teacherAnswer = generateTeacherAnswerSource(stepName, editorType, editbox, ddm);
...
const generateISL = () => {
    ...
    const islCode = getISLCode(statementStepsList, staticSourceAnsList, resolutionStepsList, statementSteps, resolutionSteps, staticSourceList, triesModule, apModuleList, extraTeacher, teacherAnswer, teacherHTML, finalAP, intermidiateFunction, generateNumListFunction, stikeMathFunction);
